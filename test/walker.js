...
function testExample (example, assertions) {
  return function () {
    this.walk(example)
    const statement = this.callbacks.processNode.firstCall.args[0]
  ...
  suite('AST Walker', function () {
    ...
    suite('ES5', function () {
      suite('Statements', function () {
        ...
        test('empty block statement', function () {
          this.walk('{}')
          const blockNode = this.callbacks.processNode.firstCall.args[0]
        ...
        test('expression statement', function () {
          this.walk('a')
          const statement = this.callbacks.processNode.firstCall.args[0]
          const expression = this.callbacks.processNode.secondCall.args[0]
        ...
        test('break statement (with label)', function () {
          ...
          const statement = this.callbacks.processNode.firstCall.args[0].body
        ...
        test('continue statement', function () {
          ...
          const statement = this.callbacks.processNode.firstCall.args[0].body.body[0]
      ...
      suite('Declarations', function () {
        test('function declaration', function () {
          ...
          const declaration = this.callbacks.processNode.firstCall.args[0]
        ...
        test('var declarator', function () {
          this.walk('var a = 1')
          const statement = this.callbacks.processNode.firstCall.args[0]
          const declarator = this.callbacks.processNode.secondCall.args[0]
      ...
      suite('Expressions', function () {
        test('this expression', function () {
          this.walk('this')
          const expression = this.callbacks.processNode.firstCall.args[0].expression
      ...
      suite('Clauses', function () {
        test('switchcase', function () {
          ...
          const cases = this.callbacks.processNode.firstCall.args[0].cases
        ...
        test('catch clause', function () {
          ...
          const clause = this.callbacks.processNode.firstCall.args[0].handler
    ...
    suite('ES2015', function () {
      ...
      test('template literal', function () {
        ...
        const literal = this.callbacks.processNode.firstCall.args[0].expression
      ...
      test('object pattern', function () {
        this.walk('({foo}) => {}')
        const pattern = this.callbacks.processNode.firstCall.args[0].expression.params[0]
      ...
      suite('classes', function () {
        ...
        test('method definition', function () {
          ...
          const constructor = this.callbacks.processNode.firstCall.args[0].body.body[0]
          ...
          const bar = this.callbacks.processNode.firstCall.args[0].body.body[1]
          ...
          const baz = this.callbacks.processNode.firstCall.args[0].body.body[2]
        ...
        test('meta property', function () {
          ...
          const fn = this.callbacks.processNode.firstCall.args[0]
          const expression = fn.body.body[0].expression
